...
/* *** Size / Rotation */
[VIMSIZE_H_CC_ROT] = TAP_DANCE_SSSS(SS_RGUI("w")"w", SS_RGUI("w")"r", TAPPING_TERM),
[VIMSIZE_J_FLIP]   = TAP_DANCE_SSSS(SS_RGUI("w")"h", SS_RGUI("w")"f", TAPPING_TERM),
[VIMSIZE_K_FLOP]   = TAP_DANCE_SSSS(SS_RGUI("w")"H", SS_RGUI("w")"F", TAPPING_TERM),
[VIMSIZE_L_C_ROT]  = TAP_DANCE_SSSS(SS_RGUI("w")"W", SS_RGUI("w")"R", TAPPING_TERM),
